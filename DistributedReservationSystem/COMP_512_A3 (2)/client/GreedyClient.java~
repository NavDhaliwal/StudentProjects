...
public class GreedyClient {
            ...
            for (int i = 0; i < iterationum; i++) {
                ...
                switch (type) {
                    case 0://reserve flight
                        ...
                        sendCommand("queryflight," + i + "," + flightnum);
                        sendCommand("reserveflight," + i + "," + customerid + "," + flightnum);
                        break;
                    case 1://reserve room
                ...
                if (--weight == 0) {
                    if (loadidx == loadconf.size()) loadidx = 0;
                    else {
                        loadidx++;
                    }
                }
    ...
    public static void main(String args[]) {
        ...
        String [] locationlist = new String [args.length - 8];
        client.testPerformance(args[2], args[3], Integer.parseInt(args[4]), Integer.parseInt(args[5]),
                Integer.parseInt(args[6]), Integer.parseInt(args[7]), Arrays.copyOfRange(locationlist, 8, args.length - 1));
