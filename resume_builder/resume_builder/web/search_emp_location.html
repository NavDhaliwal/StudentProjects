...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" background="./JobSearchNewspaper.jpg">
  ...
  <tr>
    <td align="center" valign="top"><form name="form1" method="post" action="search_location_success.jsp">
      <table width="251" border="0">
        <tr>
          <td align="left"><font color="#990000">City</font></td>
          <td align="left"><label>
            <input type="text" name="textfield">
          </label></td>
        </tr>
        <tr>
          <td align="left"><font color="#990000">State</font></td>
          <td align="left"><input type="text" name="textfield2"></td>
        </tr>
        <tr>
          <td align="left"><font color="#990000">Country</font></td>
