...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" background="./JobSearchNewspaper.jpg">
  <tr>
    <td width="18%" height="380" rowspan="3" valign="top">&nbsp;
      ...
      <p>&nbsp; </p>
    <p></td>
    <td width="60%" height="26" align="center" valign="top"><strong><font size="5">Search Results </font></strong>
  ...
  <tr>
    <td align="center" valign="top"><form name="form1" method="post" action="">
      <table width="311" border="0">
        <tr>
          <td width="176" align="left">Employee Id </td>
          <td width="125" align="left">Employee Name  </td>
        </tr>
        <tr>
          <td align="left"><label><a href="details.htm"><font color="#990000">1</font></a></label></td>
          <td align="center">&nbsp;</td>
        </tr>
        <tr>
          <td align="center">&nbsp;</td>
