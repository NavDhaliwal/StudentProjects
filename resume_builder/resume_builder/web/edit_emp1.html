...
<table width="114%" height="172" border="0" cellspacing="0">
  <tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="./JobSearchNewspaper.jpg">
  <tr>
    <td width="18%" height="380" valign="top">&nbsp;
      ...
      <p>a </p>
    <p></td>
    <td width="60%" valign="top"><p><font size="4"><strong>Enter Employee Details</strong></font></p>
      ...
      <form name="form1" method="post" action="edit_emp1_success.jsp">
        <table width="281" border="0" align="center" bordercolor="#F0F0F0">
          ...
          <%
          Connection con;Boolean b=false; ;
...
Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
  ...
  String s=null ;
  s=request.getParameter("textfield12");
  out.println(s);
...
//out.println(rs4.getString(1)) ;
    ...
    out.println(e);
          ...
          <tr>
            ...
            <td colspan="4">
              <label>
              <input name="textfield" type="text" value="<% if(b!=false) out.println(rs.getString(1));%>" readonly>
              </label>            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td colspan="4"><input type="text" name="textfield4" value="<%if(b!=false)out.println(rs.getString(2));%>"></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td colspan="4"><input type="text" name="textfield5"value="<%if(b!=false)out.println(rs.getString(3));%>"></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td colspan="4"><input type="text" name="textfield6"value="<%if(b!=false)out.println(rs.getString(4));%>"></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td colspan="2"><label>
              <input type="text" name="textfield2"value="<%if(b!=false)out.println(rs.getString(5));%>" readonly>
            </label></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td><label></label></td>
          ...
          <tr>
            ...
            <td colspan="2"><label>
              <input type="text" name="textfield3" value="<%if(b!=false)out.println(rs.getString(6));%>"readonly>
            </label></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td colspan="2"><label>
              <select name="select4">
            <%String ss="NULL"; if(rs3.next()!=false)ss=rs3.getString(1);%> <option value="<%out.println(ss);%>" selected><%out.println(ss);%></option>
            ...
            <td><select name="select5">
              <%ss="NULL"; if(rs3.next()!=false)ss= rs3.getString(1);%> <option value="<%out.println(ss);%>" selected><%out.println(ss);%></option>
          ...
          <tr>
            ...
            <td><label>
              <select name="select7">
             <% ss="NULL"; if(rs4.next()!=false)ss= rs4.getString(1);%> <option value="<%out.println(ss);%>" selected><%out.println(ss);%></option>
 ...
 <% ss="NULL"; if(rs4.next()!=false)ss= rs4.getString(1);%> <option value="<%out.println(ss);%>" selected><%out.println(ss);%></option>
          ...
          <tr>
            <td nowrap>Salary</td>
            <td colspan="4"><input type="text" name="textfield76"value="<%if(b!=false)out.println(rs.getString(7));%>"></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td colspan="4"><input type="text" name="textfield73"value="<%if(b!=false)out.println(rs.getString(8));%>"></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td nowrap>City</td>
            <td colspan="4"><input type="text" name="textfield72"value="<%if(b!=false)out.println(rs.getString(9));%>"></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td nowrap>State</td>
            <td colspan="4"><input type="text" name="textfield74"value="<%if(b!=false)out.println(rs.getString(10));%>"></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td colspan="4"><input type="text" name="textfield75"value="<%if(b!=false)out.println(rs.getString(11));%>"></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td colspan="4"><label>
              <input type="text" name="textfield7"value="<%if(rs1.next()!=false)out.println(rs1.getString(1));%>">
            </label></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            ...
            <td colspan="4"><label>
              <input type="text" name="textfield8"value="<%if(rs2.next()!=false)out.println(rs2.getString(1));%>">
            </label></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
