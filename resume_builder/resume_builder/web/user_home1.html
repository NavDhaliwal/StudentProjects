...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="./JobSearchNewspaper.jpg">
  <tr>
    <td width="18%" height="380" valign="top">&nbsp;
      ...
      <p>a </p>
    <p></td>
    <td width="60%" valign="top"><p><strong><font size="4">User Details </font></strong></p>

      <label></label>
      <form name="form1" method="post" action="user_update_success.jsp">
...
//out.println(rs4.getString(1)) ;
    ...
    out.println(e);
          ...
          <tr>
            ...
            <td colspan="4"><input name="textfield4" type="text" id="textfield4" value="<%out.println(rs.getString(2));%>"></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td colspan="4"><input name="textfield5" type="text" id="textfield5"value="<%out.println(rs.getString(3));%>"></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td colspan="4"><input name="textfield6" type="text" id="textfield6"value="<%out.println(rs.getString(4));%>"></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td colspan="2"><label>
              <input name="textfield10" type="text" id="textfield10"value="<%out.println(rs.getString(5));%>" readonly>
            </label></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td><label></label></td>
                                               ...
                                               function DoCustomValidation()
{
 ...
 frmvalidator.addValidation("textfield4","maxlen=20","Max length for textfield4 is 20");
