...
Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
         ...
         ps=con.prepareStatement("select emp_id,specializations from emp_spec where specializations like ?");
          ps1=con.prepareStatement("select emp_id,specializations from emp_spec where specializations like ?");
           ps2=con.prepareStatement("select emp_id,specializations from emp_spec where specializations like ?");
       ps.setString(1,s);
        rs=ps.executeQuery();
ps1.setString(1,s1);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="./JobSearchNewspaper.jpg">
  <tr>
    <td valign="top">&nbsp;</td>
    <td width="65%" align="center" valign="middle"><strong><font size="4">Edit Employee </font></strong>
    <td colspan="2">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td height="134" align="center" valign="top"><table width="660" border="0">
      <tr>
        ...
        <td width="132">Specialization1</td>
        <td width="132">Specialization2</td>
        <td width="132">Specialization3</td>
