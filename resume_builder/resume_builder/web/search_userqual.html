...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" background="./JobSearchNewspaper.jpg">
  ...
  <tr>
    <td align="center" valign="top"><form name="form1" method="post" action="search_userqual_success.jsp">
      <table width="251" border="0">
        <tr>
          <td width="101" align="left">Qualifications</td>
          <td width="69" align="left"><select name="select4">
