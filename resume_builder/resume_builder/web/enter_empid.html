...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="./JobSearchNewspaper.jpg">
  ...
  <tr>
    <td width="15%" height="380" valign="top">&nbsp;
      ...
      <p>&nbsp; </p>
    <p></td>
    <td width="58%" colspan="2" align="right" valign="top"><form name="form1" method="post" action="user_reg - Copy.jsp">
      <table width="390" border="0" align="center">
        <tr>
          <td colspan="3" align="center"><label></label>
              <label>ENTER YOUR EMPLOYEE ID </label></td>
        </tr>
        <tr>
          <td height="27" colspan="3">&nbsp;</td>
        </tr>
        <tr>
          <td width="92" height="15"><p>
              <label></label>
              <label></label>
          </p></td>
          <td width="92" align="center">Employee Id </td>
          <td width="194"><label>
            <input type="text" name="textfield">
          </label></td>
        </tr>
        <tr>
          <td height="17" colspan="2"><p>&nbsp;</p>
            <p>&nbsp;</p></td>
          <td height="17"><label>
