...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="./JobSearchNewspaper.jpg">
  <tr>
    <td valign="top">&nbsp;</td>
    <td align="left" valign="middle"><strong><font size="5">Welcome User </font></strong>
  ...
  <tr>
    <td width="15%" height="380" valign="top">&nbsp;
      ...
      <p>&nbsp; </p>
    <p></td>
    <td width="25%" align="left" valign="top"><form name="form1" method="post" action="admin_home.htm">
      <label>
      <!-- -->Hello User!! <br>
      You have successfully registered with our company.You will be contacted once we have a suitable job for you.
      <br>
</label>
      . 
    </form>
      <p><a href="#"><font color="#990000">BUILD RESUME </font></a></p>
      <p><a href="user_home1.jsp"><font color="#990000">UPDATE DETAILS</font></a> </p>
      <p><br>
      </p>
