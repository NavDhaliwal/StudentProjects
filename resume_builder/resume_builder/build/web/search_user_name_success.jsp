...
Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
         ...
         ps=con.prepareStatement("select username,first_name,last_name,middle_name from new_user where lower(first_name) like lower(?) and lower(last_name) like lower(?) and lower(middle_name) like lower(?)");
        if(s!=null) {s="%"+s+"%";}
        if(s1!=null) {s1="%"+s1+"%";}
        if(s2!=null) {s2="%"+s2+"%";}
         ps.setString(1,s);
