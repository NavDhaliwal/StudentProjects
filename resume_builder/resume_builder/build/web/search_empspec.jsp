...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" background="./JobSearchNewspaper.jpg">
  ...
  <tr>
    <td align="center" valign="top"><form name="form1" method="post" action="search_empspecl_success1.jsp">
      <table width="251" border="0">
        <tr>
          <td width="101" align="left">Specializations</td>
          <td width="69" align="left"><select name="select4" id="select4">
          ...
          <td width="69" align="left"><select name="select">
            <option value="NULL">(SELECT)</option>
            <option value="C">C</option>
            <option value="C++">C++</option>
            <option value="JAVA">JAVA</option>
          ...
          <td width="140" align="left"><select name="select2">
            <option value="NULL">(SELECT)</option>
            <option value="C">C</option>
            <option value="C++">C++</option>
            <option value="JAVA">JAVA</option>
        ...
        <tr>
          <td height="21" colspan="4" align="left"><a href="#"></a></td>
        </tr>
      </table>
        </form>
  </tr>
