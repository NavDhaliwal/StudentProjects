...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="./JobSearchNewspaper.jpg">
  <tr>
    <td valign="top">&nbsp;</td>
    <td width="65%" align="center" valign="middle"><strong><font size="4">Delete Employee </font></strong>
    <td colspan="2">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td align="center" valign="top"><form name="form1" method="post" action="delete_emp_success.jsp">
