...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" background="./JobSearchNewspaper.jpg">
  <tr>
    <td width="18%" height="380" rowspan="3" valign="top">&nbsp;
      ...
      <p>&nbsp; </p>
    <p></td>
    <td width="60%" height="26" align="center" valign="top"><strong><font size="5">Search Criteria</font></strong>
  ...
  <tr>
    <td align="center" valign="top"><form name="form1" method="post" action="">
      <table width="251" border="0">
        <tr>
          <td align="left"><a href="search_empid.jsp"><font color="#990000">Employee Id </font></a></td>
        </tr>
        <tr>
          <td align="left"><a href="search_emp_name.jsp"><font color="#990000">Employee Name </font></a></td>
        </tr>
        <tr>
          <td align="left"><a href="search_empqual .jsp"><font color="#990000">Qualification</font></a></td>
        </tr>
        <tr>
          <td align="left"><a href="search_empspec.jsp"><font color="#990000">Specialization</font></a></td>
        </tr>
        <tr>
          <td height="21" align="left"><a href="search_loc.jsp"><font color="#990000">Location</font></a></td>
        </tr>
      </table>
        </form>
  </tr>
