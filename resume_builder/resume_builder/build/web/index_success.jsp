...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="./JobSearchNewspaper.jpg">
  <tr>
    ...
    <td align="right" valign="middle"><a href="user_reg.jsp"></a>
    <td colspan="2">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td width="15%" height="380" valign="top">&nbsp;
      ...
      <p>&nbsp; </p>
    <p></td>
    <td width="58%" colspan="2" align="right" valign="top">
   
      <table width="390" border="0" align="center">
        <tr>
          <td colspan="3" align="left"><label></label>
              <label>ARE YOU ALREADY EMPLOYEE OF THE COMPANY </label></td>
        </tr>
        <tr>
          <td colspan="3">&nbsp;</td>
        </tr>
        <tr>
          ...
          <td width="92" align="center"><a href="enter_empid.jsp"><font color="#990000">Yes</font></a></td>
          <td width="194"><a href="user_reg.jsp"><font color="#990000">No</font></a></td>
        </tr>
      </table>
      <p><br>
      </p>
