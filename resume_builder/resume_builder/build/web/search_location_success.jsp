...
Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
         ...
         ps=con.prepareStatement("select emp_id,first_name,last_name,middle_name,city,state,country from emp_details where lower(city) like lower(?) and lower(state) like lower(?) and lower(country) like lower(?)");
        if(s!=null) {s="%"+s+"%";}
        if(s1!=null) {s1="%"+s1+"%";}
        if(s2!=null) {s2="%"+s2+"%";}
         ps.setString(1,s);
  ...
  <tr>
    ...
    <td height="134" align="center" valign="top"><table width="660" border="0">
      <tr>
        ...
        <td width="132">City</td>
        <td width="132">State</td>
        <td width="132">Country</td>
      </tr>
	  <%
	  while(rs.next())
	  {
